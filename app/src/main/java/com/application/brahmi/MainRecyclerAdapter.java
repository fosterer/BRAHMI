...
public class MainRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder viewHolder, final int position) {
        if (getItemViewType(position) == ACTIVE) {
            ...
            holder.linearLayout.setBackgroundColor(colors[viewHolder.getAdapterPosition() % 7]);
            ...
            holder.finishTaskButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mDataset.get(viewHolder.getAdapterPosition()).setTimeInMilliseconds(0);
                    dbHandler.updateTask(mDataset.get(viewHolder.getAdapterPosition()));
                    ((DailyActivity) context).removeTimer(mDataset.get(viewHolder.getAdapterPosition()));
                    update();
                }
            });
            ...
            if (countdownTimers.get(viewHolder.getAdapterPosition()).mMillisInFuture != 0) {
                holder.countDownTimer = new CountDownTimer(mDataset.get(viewHolder.getAdapterPosition()).getTimeInMilliseconds()
            ...
            holder.title.setText(mDataset.get(viewHolder.getAdapterPosition()).getName());
